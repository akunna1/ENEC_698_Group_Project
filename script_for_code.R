...
# Removing the rows of column year_construction_started containing NAs
eui_data_n1 <- filter(eui_data_joined, !is.na(eui_data_joined$Year_construction_started))
view(eui_data_n1) #gives 234 entries
...
#Plotting
ggplot()+
  geom_point(data = eui_data_n2, mapping = aes(x=Year_construction_started, y=Latest_reno))